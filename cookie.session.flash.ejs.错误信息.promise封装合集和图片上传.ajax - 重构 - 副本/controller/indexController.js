...
exports.all = function (req, res, next) {
    ...
    if (reqUrl.endsWith('login.do') || reqUrl.endsWith('logout.do') ||reqUrl.endsWith('checkUser.do') ||reqUrl.endsWith('register.do') ||reqUrl.endsWith('registerSubmit.do') || reqUrl.endsWith('/') || reqUrl === '') {
        next(); // 放行
    } else {
...
exports.login = function (req, res) {
    ...
    // console.log('msg :' + msg);
    logger.debug('msg :' + msg);      // logger的运用
